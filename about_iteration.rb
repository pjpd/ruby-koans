...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Injects the argument as the first piped value, and the next array value
    # as the second piped value. For each iteration across the array, the result
    # of the block becomes the first piped value.
  end
